...
# 
# connection point irq_reader
# 
add_interface irq_reader avalon end
set_interface_property irq_reader addressUnits WORDS
set_interface_property irq_reader associatedClock clock
set_interface_property irq_reader associatedReset reset
set_interface_property irq_reader bitsPerSymbol 8
set_interface_property irq_reader burstOnBurstBoundariesOnly false
set_interface_property irq_reader burstcountUnits WORDS
set_interface_property irq_reader explicitAddressSpan 0
set_interface_property irq_reader holdTime 0
set_interface_property irq_reader linewrapBursts false
set_interface_property irq_reader maximumPendingReadTransactions 0
set_interface_property irq_reader maximumPendingWriteTransactions 0
set_interface_property irq_reader readLatency 0
set_interface_property irq_reader readWaitTime 1
set_interface_property irq_reader setupTime 0
set_interface_property irq_reader timingUnits Cycles
set_interface_property irq_reader writeWaitTime 0
set_interface_property irq_reader ENABLED true
set_interface_property irq_reader EXPORT_OF ""
set_interface_property irq_reader PORT_NAME_MAP ""
set_interface_property irq_reader CMSIS_SVD_VARIABLES ""
set_interface_property irq_reader SVD_ADDRESS_GROUP ""

add_interface_port irq_reader irq_serviced read Input 1
add_interface_port irq_reader irq_serviced_data readdata Output 8
set_interface_assignment irq_reader embeddedsw.configuration.isFlash 0
set_interface_assignment irq_reader embeddedsw.configuration.isMemoryDevice 0
set_interface_assignment irq_reader embeddedsw.configuration.isNonVolatileStorage 0
set_interface_assignment irq_reader embeddedsw.configuration.isPrintableDevice 0
