...
8. Convert the .sof to .rbf using File > Convert Programming Files. Make sure 'Compression' is ticked under Properties. You may run across [this](https://community.intel.com/t5/Intel-High-Level-Design/altera-fpga-manager-ff706000-fpgamgr-timeout/m-p/1146465) error if you forget.
